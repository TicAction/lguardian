        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @elseif(Auth::guard('orthos')->user())
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                {{ Auth::guard('orthos')->user()->name }} <span class="caret"></span>
                            </a>

                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/ortho/logout') }}"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    ...
                    @else
                        ...
                        <li><a href="{{ url('/ortho/login') }}">Login Ortho</a></li>
                        <li><a href="{{ url('/register') }}">Register User</a></li>
                        <li><a href="{{ url('/admin/register') }}">Register Admin</a></li>
                        <li><a href="{{ url('/ortho/register') }}">Register Ortho</a></li>
                    @endif
