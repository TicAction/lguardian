            ...
            @foreach($fHomeworks as $fHomework)
                ...
                <table class="table table-striped table-responsive">
                    ...
                    @if($fHomework->univers_social)
                        <tr class="text-left">
                            <td class="text-danger">Univers Social :</td>
                            <td>{!! $fHomework->univers_social !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->arts)
                        <tr class="text-left">
                            <td class="text-danger">Arts :</td>
                            <td>{!! $fHomework->arts !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->science)
                        <tr class="text-left">
                            <td class="text-danger">Science technologie :</td>
                            <td>{!! $fHomework->science !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->ecr)
                        <tr class="text-left">
                            <td class="text-danger">Éthique culture religieuse :</td>
                            <td>{!! $fHomework->ecr !!}</td>
                        </tr>
                    @endif
                    <tr>
                    ...
                    @if($fHomework->devoir_mathematique)
                        <tr class="text-left">
                            <td class="text-danger">Devoir de mathématique :</td>
                            <td>{!! $fHomework->devoir_mathematique !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->devoir_francais)
                        <tr class="text-left">
                            <td class="text-danger">Devoir de français :</td>
                            <td>{!! $fHomework->devoir_francais !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->devoir_autres)
                        <tr class="text-left">
                            <td class="text-danger">Autres travaux :</td>
                            <td>{!! $fHomework->devoir_autres !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->anglais)
                        <tr class="text-left">
                            <td class="text-danger">Devoir d'Anglais :</td>
                            <td>{!! $fHomework->anglais !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->musique)
                        <tr class="text-left">
                            <td class="text-danger">Devoir de musique :</td>
                            <td>{!! $fHomework->musique !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->edu)
                        <tr class="text-left">
                            <td class="text-danger">Devoir d'éducation physique :</td>
                            <td>{!! $fHomework->edu !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->signature)
                        <tr class="text-left">
                            <td class="text-danger">Signature de la semaine :</td>
                            <td>{!! $fHomework->signature !!}</td>
                        </tr>
                    @endif
                    @if($fHomework->remettre)
                        <tr class="text-left">
                            <td class="text-danger">Travaux ou feuilles à remettre :</td>
